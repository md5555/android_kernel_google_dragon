/* linux/arch/arm/mach-s5pv210/include/mach/regs-sdaout.h
*
...
/* SDO_SCALE_CHx */
#define SDO_SCALE_CONV_OFFSET(x)		((0x3ff&x)<<16)
#define SDO_SCALE_CONV_GAIN(x)			(0xfff&x)

/* SDO_YCDELAY */
#define SDO_DELAY_YTOC(x)			((0xf&x)<<16)
#define SDO_ACTIVE_START_OFFSET(x)		((0xff&x)<<8)
#define SDO_ACTIVE_END_OFFSET(x)		(0xff&x)
...
/* SDO_FINFO */
#define SDO_FIELD_MOD_1001(x)			(((0x3ff<<16)&x)>>16)
#define SDO_FIELD_ID_BOTTOM(x)			((1<<1)&x)
...
/* SDO_YSCALE */
#define SDO_BRIGHTNESS_GAIN(x)			((0xff&x)<<16)
#define SDO_BRIGHTNESS_OFFSET(x)		(0xff&x)

/* SDO_CBSCALE */
#define SDO_HS_CB_GAIN0(x)			((0x1ff&x)<<16)
#define SDO_HS_CB_GAIN1(x)			(0x1ff&x)

/* SDO_CRSCALE */
#define SDO_HS_CR_GAIN0(x)			((0x1ff&x)<<16)
#define SDO_HS_CR_GAIN1(x)			(0x1ff&x)

/* SDO_CB_CR_OFFSET */
#define SDO_HS_CR_OFFSET(x)			((0x3ff&x)<<16)
#define SDO_HS_CB_OFFSET(x)			(0x3ff&x)

/* SDO_RGB_CC */
#define SDO_MAX_RGB_CUBE(x)			((0xff&x)<<8)
#define SDO_MIN_RGB_CUBE(x)			(0xff&x)

/* SDO_CVBS_CC_Y1 */
#define SDO_Y_LOWER_MID_CVBS_CORN(x)		((0x3ff&x)<<16)
#define SDO_Y_BOTTOM_CVBS_CORN(x)		(0x3ff&x)

/* SDO_CVBS_CC_Y2 */
#define SDO_Y_TOP_CVBS_CORN(x)			((0x3ff&x)<<16)
#define SDO_Y_UPPER_MID_CVBS_CORN(x)		(0x3ff&x)

/* SDO_CVBS_CC_C */
#define SDO_RADIUS_CVBS_CORN(x)			(0x1ff&x)

/* SDO_YC_CC_Y */
#define SDO_Y_TOP_YC_CYLINDER(x)		((0x3ff&x)<<16)
#define SDO_Y_BOTOM_YC_CYLINDER(x)		(0x3ff&x)

/* SDO_CVBS_CC_C */
#define SDO_RADIUS_YC_CYLINDER(x)		(0x1ff&x)

/* SDO_CSC_525_PORCH */
#define SDO_COMPONENT_525_BP(x)			((0x3ff&x)<<16)
#define SDO_COMPONENT_525_FP(x)			(0x3ff&x)

/* SDO_CSC_525_PORCH */
#define SDO_COMPONENT_625_BP(x)			((0x3ff&x)<<16)
#define SDO_COMPONENT_625_FP(x)			(0x3ff&x)
...
/* SDO_OSFCxx_x */
#define SDO_OSF_COEF_ODD(x)			((0xfff&x)<<16)
#define SDO_OSF_COEF_EVEN(x)			(0xfff&x)

/* SDO_XTALKx */
#define SDO_XTALK_COEF02(x)			((0xff&x)<<16)
#define SDO_XTALK_COEF01(x)			(0xff&x)

/* SDO_BB_CTRL */
#define SDO_REF_BB_LEVEL_NTSC			(0x11x<<8)
...
/* SDO_ARMCC */
#define SDO_DISPLAY_CC_CAPTION(x)		((0xff&x)<<16)
#define SDO_NON_DISPLAY_CC_CAPTION(x)		(0xff&x)

#define SDO_CRC_WSS525(x)			((0x3f&x)<<14)
...
#define SDO_CRC_CGMS525(x)			((0x3f&x)<<14)

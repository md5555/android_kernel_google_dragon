...
#define RT5677_DSP_BCLK_AUTO_MODE_MASK		(0x1 << 8)
#define RT5677_DSP_BCLK_AUTO_MODE_SFT		8
#define RT5677_DSP_BCKK_AUTO_MODE_EN		(0x1 << 8)
#define RT5677_DSP_BCKK_AUTO_MODE_DIS		(0x0 << 8)
#define RT5677_DSP_BUS_PRE_DIV_AUTO_MASK	(0xf << 4)
#define RT5677_DSP_BUS_PRE_DIV_AUTO_SFT		4
#define RT5677_DSP_BUS_PRE_DIV_MASK		(0xf << 0)
#define RT5677_DSP_BUS_PRE_DIV_SFT		0

...
/* HSD_CTRL (0xc) */
/* Enables Automatic Headset Detection. It will automatically detect MIC/GND switching readable in Regx82[11:10] */
...
#define NAU8825_JAMNODCLOW	(1 << 10) // ask Nuvoton what this register does

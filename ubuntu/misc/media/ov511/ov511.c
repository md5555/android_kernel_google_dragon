...
static ssize_t show_custom_id(struct device *cd, struct device_attribute *attr, char *buf)
{
...
static ssize_t show_bridge(struct device *cd, struct device_attribute *attr, char *buf)
{
	struct usb_ov511 *ov = cd_to_ov(cd);
	return sprintf(buf, "%s\n", symbolic(brglist, ov->bridge));
} 
...
static ssize_t show_sensor(struct device *cd, struct device_attribute *attr, char *buf)
{
	struct usb_ov511 *ov = cd_to_ov(cd);
...
static ssize_t show_brightness(struct device *cd, struct device_attribute *attr, char *buf)
{
	struct usb_ov511 *ov = cd_to_ov(cd);
	unsigned short x;
...
static ssize_t show_saturation(struct device *cd, struct device_attribute *attr, char *buf)
{
	struct usb_ov511 *ov = cd_to_ov(cd);
	unsigned short x;
...
static ssize_t show_exposure(struct device *cd, struct device_attribute *attr, char *buf)
{
	struct usb_ov511 *ov = cd_to_ov(cd);
	unsigned char exp = 0;
...
static void ov_create_sysfs(struct device *dev)
{
	device_create_file(dev, &dev_attr_custom_id);
	device_create_file(dev, &dev_attr_model);
	device_create_file(dev, &dev_attr_bridge);
	device_create_file(dev, &dev_attr_sensor);
	device_create_file(dev, &dev_attr_brightness);
	device_create_file(dev, &dev_attr_saturation);
	device_create_file(dev, &dev_attr_contrast);
	device_create_file(dev, &dev_attr_hue);
	device_create_file(dev, &dev_attr_exposure);
}

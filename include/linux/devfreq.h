...
enum devfreq_watermark_event_type {
	DEVFREQ_WATERMARK_EVENT_NONE,
	DEVFREQ_WATERMARK_EVENT_ABOVE,
	DEVFREQ_WATERMARK_EVENT_BELOW,
};
...
static inline int devfreq_watermark_event(struct devfreq *devfreq, int type)
{
	return 0;
}

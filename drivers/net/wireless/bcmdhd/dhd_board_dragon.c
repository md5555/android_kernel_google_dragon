...
static int dragon_wifi_get_mac_addr(struct wifi_platform_data * pdata, unsigned char *buf);
static void *dragon_wifi_get_country_code(struct wifi_platform_data * pdata, char *country_iso_code, u32 flags);

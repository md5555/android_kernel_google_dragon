...
#define DSI_HOST_CONTROL_ULPM_NORMAL	(0 << 8)
#define DSI_HOST_CONTROL_ULPM_ENTER	(1 << 8)
#define DSI_HOST_CONTROL_ULPM_EXIT	(2 << 8)
#define DSI_HOST_CONTROL_ULPM_MASK	(3 << 8)

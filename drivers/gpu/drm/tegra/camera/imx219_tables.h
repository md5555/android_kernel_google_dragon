...
struct imx219_table_entry {
	u32 xres;
	u32 yres;
	struct imx219_reg *mode_table;
};
...
static struct imx219_reg imx219_read_prep[] = {
	{0x012A, 0x18},		/* 24Mhz input */
	{0x012B, 0x00},
	{0x3302, 0x02},		/* clock setting */
	{0x3303, 0x58},		/* clock setting */
	{0x3300, 0},		/* ECC ON */
	{0x3200, 1},		/* set 'Read' */
	{0x3202, 1},		/* page 1 */
	{IMX219_TABLE_END, 0x00}
...
static struct imx219_table_entry mode_list[] = {
	{3280, 2460, mode_3280x2460},
	{3280, 1846, mode_3280x1846},
	{1640, 1232, mode_1640x1232},
	{1280, 720, mode_1280x720}
};

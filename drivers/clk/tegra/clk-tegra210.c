...
static struct tegra_clk tegra210_clks[tegra_clk_max] __initdata = {
	...
	[tegra_clk_uarta_8] = { .dt_id = TEGRA210_CLK_UARTA, .present = false },
	...
	[tegra_clk_uartc_8] = { .dt_id = TEGRA210_CLK_UARTC, .present = false },
	[tegra_clk_mipi_cal] = { .dt_id = TEGRA210_CLK_MIPI_CAL, .present = true },
	[tegra_clk_emc] = { .dt_id = TEGRA210_CLK_EMC, .present = true },
	[tegra_clk_usb2] = { .dt_id = TEGRA210_CLK_USB2, .present = true },
	[tegra_clk_bsev] = { .dt_id = TEGRA210_CLK_BSEV, .present = true },
	[tegra_clk_uartd_8] = { .dt_id = TEGRA210_CLK_UARTD, .present = false },
	...
	[tegra_clk_uartb_8] = { .dt_id = TEGRA210_CLK_UARTB, .present = false },
	...
	[tegra_clk_uartape] = { .dt_id = TEGRA210_CLK_UARTAPE, .present = false },

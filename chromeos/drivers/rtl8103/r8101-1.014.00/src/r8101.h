...
#define RTL8101_VERSION "1.014.00" NAPI_SUFFIX
#define MODULENAME "r8101"
#define PFX MODULENAME ": "

#define GPL_CLAIM "\
r8101  Copyright (C) 2009  Realtek NIC software team <nicfae@realtek.com> \n \
...
#define RX_BUF_SIZE	1519	/* Rx Buffer size */
...
#define RTL8101_ASPM_TIMEOUT		(2*HZ)
#define RTL8101_LINK_DOWN_TIMEOUT	(1*HZ)
#define RTL8101_ESD_TIMEOUT		(2*HZ)
#define RTL8101_LINK_DOWN_CHECK_TIMEOUT	(10*HZ)
...
struct rtl8101_private {
	...
	struct timer_list link_down_check_timer;
	...
	unsigned features;
	int link_down_check_timer_enable;
};
